...
function createMenuItem(userName, userPrice, userCategory){
  const newItem = {name: userName, price: userPrice, category: userCategory};
  return newItem;
}
...
*/
const coke = createMenuItem("Coke", 3, "Drinks");
console.log(coke);
const pizza = createMenuItem("Pizza", 8, "Lunch");
console.log(pizza);
...
export const burger = {
  ...
  discount: function(string){
    if (string == "teacher" || string == "student"){
      ...
      console.log("Error, please indicate whether you are a teacher, student, or member of the public.");
    }
  }
}
...
*/
reviews.push({name: "Mikayla", rating: 0, feedback: "This was horrendous!"});
